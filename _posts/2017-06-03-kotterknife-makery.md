---
layout: post
title: Kottern Knife Makery
categories: android
version: 2.0.1
source-url: https://github.com/ReactiveX/RxKotlin
tags: [android, library, reactive]
description: Butter Knife-esque view binding for Kotlin.
image:
author:
  email: ReactiveX@y.com
  display_name: ReactiveX
  first_name: ReactiveX
  last_name: ReactiveX
---
Kotter Knife
============
